...
```{r membelikan-synvalence-visualisation, fig.asp=0.8, dpi=300, fig.width=7, fig.cap="Syntactic transitivity of *membelikan*"}
...
```{r membelikan-cxntype-synvalence-visualisation, fig.asp=0.8, dpi=300, fig.width=7, fig.cap="Syntactic transitivity and construction types of *membelikan*"}
