...
- The .qmd file contains the R codes used to produce the quantitative analyses in the paper, including the statistical figures. This .qmd file also interweaves some text narratives with the codes. The file is published as a webpage at: https://gederajeg.github.io/applicative-buy/

- The raw, annotated concordance data is located in the [data](https://github.com/gederajeg/applicative-buy/tree/main/data) directory.
